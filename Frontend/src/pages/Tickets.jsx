      ...
      <div className="flex justify-between items-end">
        <div>
           <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center gap-3">
             <Ticket className="w-8 h-8 text-emerald-500" /> Tickets
           </h1>
           <p className="text-slate-500 dark:text-slate-400 mt-1 font-medium">Detailed view of all support queries.</p>
        </div>
      </div>

      <div className="bg-white/70 dark:bg-[#041209]/70 backdrop-blur-xl border border-slate-200/60 dark:border-emerald-900/20 rounded-2xl shadow-sm overflow-hidden">
        <div className="p-6">
          <TicketTable 
            tickets={tickets} 
            onBulkUpdate={bulkUpdate} 
            updateTicketAdmin={updateTicketAdmin} 
            externalFilters={initialFilters}
          />
        </div>
      </div>
    </div>
