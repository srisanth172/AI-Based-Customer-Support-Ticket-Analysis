...
const LandingPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0B0F1A] to-[#0F172A] text-slate-300 font-sans selection:bg-[#22C55E] selection:text-[#0B0F1A] overflow-x-hidden relative z-0">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-[-15%] left-1/2 -translate-x-1/2 w-[110vw] h-[800px] bg-[radial-gradient(ellipse_at_top,_rgba(34,197,94,0.13)_0%,_transparent_65%)]"
        />
        {/* Left side glow - drifts slowly */}
        <motion.div
          animate={{ opacity: [0.03, 0.07, 0.03], x: [0, 20, 0] }}
          transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-[15%] left-[-8%] w-[450px] h-[450px] bg-[#22C55E] blur-[300px] rounded-full"
        />
        {/* Right side glow */}
        <motion.div
          animate={{ opacity: [0.03, 0.06, 0.03], x: [0, -15, 0] }}
          transition={{ duration: 16, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="absolute bottom-[-8%] right-[-4%] w-[550px] h-[550px] bg-[#22C55E] blur-[300px] rounded-full"
        />
      </div>

      {/* ── NAVIGATION ── */}
      <nav className="relative z-10 flex items-center justify-between px-6 py-4 max-w-7xl mx-auto border-b border-white/[0.06] bg-[#0B0F1A]/80 backdrop-blur-xl sticky top-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/register" className="px-5 py-2 text-sm font-semibold bg-[#22C55E] text-[#0B0F1A] hover:bg-[#4ADE80] rounded-lg transition-all duration-200 shadow-[0_0_20px_rgba(34,197,94,0.25)] hover:shadow-[0_0_28px_rgba(34,197,94,0.4)] hover:-translate-y-0.5">
            Get Started
          </Link>
        </div>
      </nav>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-6 pt-24 pb-16 text-center max-w-7xl mx-auto">
        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="flex flex-col items-center max-w-4xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#22C55E]/[0.07] border border-[#22C55E]/20 text-[#4ADE80] text-[11px] font-bold uppercase tracking-[0.18em] mb-10 shadow-[0_0_20px_rgba(34,197,94,0.1)] cursor-default"
          >
          ...
          >
            ...
            <span className="absolute inset-0 -z-10 blur-[90px] opacity-[0.18] bg-[radial-gradient(ellipse_at_center,_#22C55E,_transparent_70%)]" aria-hidden="true" />
            {/* Line 1 */}
            ...
            <span className="block mt-1">
              <motion.span
                ...
                className="text-transparent bg-clip-text bg-[length:200%_auto] bg-gradient-to-r from-[#22C55E] via-[#4ADE80] to-[#22C55E] drop-shadow-[0_0_32px_rgba(34,197,94,0.4)] inline"
              >
                10x Faster
              </motion.span>
          ...
          <motion.div variants={fadeInUp} className="mb-12 flex flex-col items-center gap-4">
            {/* Primary CTA */}
            <motion.div
              whileHover={{ scale: 1.03, boxShadow: '0 0 60px rgba(34,197,94,0.4)' }}
              whileTap={{ scale: 0.97 }}
              transition={{ type: 'spring', stiffness: 320, damping: 22 }}
              className="inline-block rounded-2xl shadow-[0_8px_32px_rgba(34,197,94,0.25),_0_2px_8px_rgba(0,0,0,0.4)]"
            >
              <Link
                to="/register"
                className="inline-flex items-center justify-center bg-[#22C55E] text-[#0B0F1A] hover:bg-[#4ADE80] px-11 py-4 rounded-2xl text-[1rem] font-bold transition-colors duration-200 gap-3 group"
              >
            ...
            >
              Already have an account? <span className="text-[#4ADE80] font-semibold">Sign in →</span>
            </Link>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="flex flex-col items-center gap-5 mb-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex -space-x-2.5">
                ...
                <div className="w-8 h-8 rounded-full bg-[#22C55E]/10 border-2 border-[#0B0F1A] flex items-center justify-center text-[9px] font-bold text-[#4ADE80]">
                  +1k
                </div>
              </div>
              {/* Verified check + text */}
        ...
        <motion.div
          ...
          className="w-full max-w-5xl rounded-2xl border border-white/[0.07] bg-[#111827]/90 backdrop-blur-2xl shadow-[0_40px_120px_-20px_rgba(0,0,0,0.7),_0_0_50px_rgba(34,197,94,0.04)] overflow-hidden relative group"
        >
          {/* Edge Lighting */}
          <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#22C55E]/60 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-700"></div>

          {/* Browser Chrome */}
          <div className="flex items-center px-4 py-3 border-b border-white/[0.06] bg-[#0B0F1A]/80">
            ...
            <div className="mx-auto text-xs text-slate-500 font-mono flex items-center gap-2 bg-[#0B0F1A] px-4 py-1.5 rounded-md border border-white/[0.06]">
              <Lock size={10} className="text-[#22C55E]" /> app.swiftsupport.ai
            </div>
          </div>

          <div className="flex h-[550px] text-sm text-left relative overflow-hidden">
            {/* Sidebar */}
            <div className="w-52 border-r border-white/[0.05] p-4 flex flex-col gap-1 hidden md:flex bg-[#0B0F1A]/60">
              ...
              <div className="px-3 py-2 rounded-lg bg-[#22C55E]/10 text-[#4ADE80] flex items-center gap-3 font-medium cursor-default border border-[#22C55E]/30 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] relative overflow-hidden">
                ...
                <span className="ml-auto bg-[#22C55E] text-[#0B0F1A] text-[10px] px-2 py-0.5 rounded-full font-bold">3</span>
              </div>
            </div>
            ...
            <div className="flex-1 pt-6 px-6 pb-2 flex flex-col gap-4 relative">
              <div className="flex justify-between items-start mb-2 pb-4 border-b border-white/5">
                ...
                <div className="bg-[#22C55E]/10 border border-[#22C55E]/30 px-3 py-1.5 rounded-md flex items-center gap-2 text-xs text-[#4ADE80] font-medium backdrop-blur-md shadow-[0_0_20px_rgba(34,197,94,0.15)]">
                  <Sparkles size={14} className="text-[#22C55E]" /> AI Context Analyzed
                </div>
              </div>

              {/* Customer Chat */}
              <div className="rounded-xl bg-[#0B0F1A]/70 border border-white/[0.05] p-5">
              ...
              {/* AI Suggestion Panel */}
              <div className="mt-auto rounded-xl border border-[#22C55E]/30 bg-gradient-to-b from-[#22C55E]/[0.08] to-transparent overflow-hidden backdrop-blur-md relative shadow-[0_0_30px_rgba(34,197,94,0.05)]">
                <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#4ADE80] to-transparent opacity-60"></div>
                <div className="bg-black/20 px-4 py-2.5 border-b border-[#22C55E]/20 flex items-center justify-between">
                  <div className="text-xs text-[#4ADE80] font-bold flex items-center gap-2 tracking-wide uppercase">
                    <Bot size={14} className="text-[#22C55E]" /> Generated Draft
                  </div>
                  <div className="text-[10px] text-[#22C55E]/90 font-mono bg-[#22C55E]/10 px-2 py-0.5 rounded border border-[#22C55E]/30">98% Match</div>
                </div>
                <div className="p-4">
                  ...
                  <div className="flex gap-3">
                    <button className="px-5 py-2.5 bg-[#22C55E] text-[#020B06] hover:bg-[#4ADE80] hover:scale-105 rounded-lg text-sm font-bold transition-all shadow-[0_0_20px_rgba(34,197,94,0.2)] hover:shadow-[0_0_30px_rgba(34,197,94,0.5)]">
                      Approve & Send
                    </button>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto relative z-10 border-t border-white/[0.06] mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-12 left-[15%] right-[15%] h-[1px] bg-gradient-to-r from-transparent via-[#22C55E]/30 to-transparent"></div>
          ...
          {[
            ...
            >
            <motion.div
              whileHover={{ scale: 1.08, boxShadow: '0 0 32px rgba(34,197,94,0.2)' }}
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
              className="w-24 h-24 rounded-full bg-[#111827] border border-white/[0.07] flex items-center justify-center mb-6 shadow-xl cursor-default">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#22C55E]/20 to-transparent flex items-center justify-center text-[#4ADE80]">
                  {step.icon}
                </div>
              </motion.div>
      ...
      {/* ── STATS SECTION ── */}
      <section className="border-y border-white/[0.06] bg-[#111827] py-16 relative z-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
          {[
            ...
            >
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#22C55E]/20 to-transparent flex items-center justify-center text-[#4ADE80] mb-6 border border-[#22C55E]/30 shadow-[0_0_20px_rgba(34,197,94,0.15)]">
                {stat.icon}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              whileHover={{ y: -6, boxShadow: '0 16px 40px rgba(34,197,94,0.08)' }}
              transition={{ delay: idx * 0.1, type: 'spring', stiffness: 280, damping: 22 }}
              className="group relative p-8 rounded-2xl bg-[#111827] border border-white/[0.07] hover:border-[#22C55E]/40 hover:bg-[#22C55E]/[0.03] hover:shadow-[0_20px_40px_rgba(34,197,94,0.08)] transition-all duration-300 cursor-default overflow-hidden"
            >
              {/* Subtle hover background glow inside card */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#22C55E] blur-[80px] opacity-0 group-hover:opacity-20 transition-opacity duration-500"></div>

              <div className="w-14 h-14 rounded-xl bg-[#0B0F1A] border border-white/[0.08] flex items-center justify-center mb-6 text-slate-400 group-hover:text-[#0B0F1A] group-hover:bg-[#22C55E] group-hover:border-[#4ADE80] transition-colors shadow-lg">
                {feature.icon}
              </div>
              <h3 className="text-lg font-bold text-white mb-3 group-hover:text-[#4ADE80] transition-colors">{feature.title}</h3>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto relative z-10 border-t border-white/[0.06]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {[
            ...
            <motion.div
              key={i}
              className="p-8 rounded-2xl bg-[#111827] border border-white/[0.07] relative transition-colors duration-200"
              initial={{ opacity: 0, y: 24 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ delay: t.delay, duration: 0.65, ease: [0.16, 1, 0.3, 1] }}
              whileHover={{ borderColor: 'rgba(34,197,94,0.2)', boxShadow: '0 8px 32px rgba(34,197,94,0.06)' }}
            >
              <div className="flex gap-1 text-[#22C55E] mb-4">
              ...
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#22C55E] to-[#16A34A] flex items-center justify-center text-[10px] font-bold text-[#0B0F1A]">
      ...
      {/* ── FOOTER ── */}
      <footer className="border-t border-white/[0.06] bg-[#0B0F1A] py-10 text-sm relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6 text-slate-500">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            <Link to="#" className="hover:text-[#4ADE80] hover:underline transition-colors">Terms of Service</Link>
            <Link to="#" className="hover:text-[#4ADE80] hover:underline transition-colors">Privacy Policy</Link>
            <Link to="#" className="hover:text-[#4ADE80] hover:underline transition-colors">Contact</Link>
          </div>
